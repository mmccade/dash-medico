...
export const BIOMARCADORES = [
  ...
  // ── Hematologia específica ───────────────────────────────────
  { nome: "Homocisteína",          categoria: "Hematologia específica", refTexto: "3–14 mcmol/L",     ideal: { M: [5, 9], F: [5, 9] , sugestoes: { baixo: null, alto: ["Vitamina B12 (metilcobalamina)", "Folato ativo (metilfolato)", "Vitamina B6 (P5P)", "TMG (trimetilglicina 500–1.000 mg/dia)"] } }, unidade: "mcmol/L",
  ...
  { nome: "Ferritina",             categoria: "Hematologia específica", refTexto: "30–300 mcg/L",     ideal: { M: [100, 100], F: [100, 130] , sugestoes: { baixo: ["Ferro bisglicinato (15–30 mg/dia, longe do café)", "Vitamina C junto (aumenta absorção 3x)", "Folato ativo"], alto: null } }, unidade: "mcg/L",
  ...
  { nome: "Ferro (Sérico)",        categoria: "Hematologia específica", refTexto: "50–200 µg/dL",     ideal: { M: [80, 150], F: [70, 120] , sugestoes: { baixo: ["Ferro bisglicinato (15–30 mg/dia)", "Vitamina C (cofator de absorção)"], alto: null } }, unidade: "µg/dL" },
  ...
  // ── Perfil Lipídico ──────────────────────────────────────────
  { nome: "Colesterol Total",      categoria: "Perfil Lipídico",        refTexto: "< 200 mg/dL",     ideal: { M: [null, 240], F: [null, 240] , sugestoes: { baixo: null, alto: ["Ômega-3 EPA+DHA (2–4 g/dia)", "Berberina (consultar médico)", "Coenzima Q10 (especialmente se em uso de estatina)"] } }, unidade: "mg/dL",
    interpretacao: { alto: "Pode aumentar risco cardiovascular; reduzir gordura saturada, praticar exercícios." } },
  { nome: "LDL",                   categoria: "Perfil Lipídico",        refTexto: "< 130 mg/dL",     ideal: { M: [100, 130], F: [100, 130] , sugestoes: { baixo: null, alto: ["Ômega-3 EPA+DHA", "Fitoesteróis (2 g/dia)", "Berberina (consultar médico)"] } }, unidade: "mg/dL",
    interpretacao: { alto: "Aumenta risco de doenças cardíacas; melhorar alimentação, aumentar atividade física." } },
  { nome: "HDL",                   categoria: "Perfil Lipídico",        refTexto: "> 45 mg/dL",      ideal: { M: [50, 73], F: [60, 93] , sugestoes: { baixo: ["Ômega-3 EPA+DHA", "Vitamina D3", "Niacina (consultar médico)"], alto: null } }, unidade: "mg/dL",
  ...
  { nome: "Triglicerídeos",        categoria: "Perfil Lipídico",        refTexto: "100–400 mg/dL",   ideal: { M: [null, 250], F: [null, 100] , sugestoes: { baixo: null, alto: ["Ômega-3 EPA+DHA (3–4 g/dia)", "Cromo quelato", "Vitamina B3 (niacina – com cautela)"] } }, unidade: "mg/dL",
  ...
  // ── Avaliação Hormonal ───────────────────────────────────────
  { nome: "TSH",                  categoria: "Avaliação Hormonal",      refTexto: "0,3–4,2 mcUI/mL", ideal: { M: [1, 2], F: [1, 2.5] , sugestoes: { baixo: ["Selênio (cofator tireoidiano)", "Ashwagandha (adaptógeno – consultar médico)"], alto: ["Selênio (cofator T4→T3)", "Iodo (com cautela, somente se deficiente)", "Zinco quelato", "Vitamina D3"] } }, unidade: "mcUI/mL",
  ...
  { nome: "Testosterona Total",   categoria: "Avaliação Hormonal",      refTexto: "300–1200 / 15–70", ideal: { M: [500, 900], F: [50, 70] , sugestoes: { baixo: ["Zinco quelato (precursor testosterona)", "Vitamina D3", "Magnésio quelato (dormir bem → testosterona)", "Ashwagandha (consultar médico)"], alto: null } }, unidade: "ng/dL" },
  { nome: "Testosterona Livre",   categoria: "Avaliação Hormonal",      refTexto: "5–25 / 1–8 pg/mL",ideal: { M: [6, 8], F: [5, 7] , sugestoes: { baixo: ["Zinco quelato", "Vitamina D3", "Boro (3–6 mg/dia – reduz SHBG)", "Magnésio quelato"], alto: null } }, unidade: "pg/mL" },
  ...
  { nome: "Cortisol sérico (manhã)", categoria: "Avaliação Hormonal",   refTexto: "5–20 mg/dL",      ideal: { M: [10, 20], F: [10, 20] , sugestoes: { baixo: ["Vitamina C", "Ácido pantotenônico (B5)", "Ashwagandha (adaptógeno – consultar médico)"], alto: ["Magnésio quelato (reduz cortisol)", "Ashwagandha (adaptógeno – consultar médico)", "Rhodiola rosea (consultar médico)", "Vitamina C"] } }, unidade: "mg/dL" },
  ...
  // ── Avaliação Metabólica ─────────────────────────────────────
  { nome: "Glicose",              categoria: "Avaliação Metabólica",    refTexto: "70–110 mg/dL",     ideal: { M: [75, 90], F: [75, 90] , sugestoes: { baixo: null, alto: ["Cromo quelato (200–400 mcg/dia)", "Magnésio quelato", "Berberina 500 mg (consultar médico)", "Ácido alfa-lipóico (ALA 300–600 mg/dia)"] } }, unidade: "mg/dL",
  ...
  { nome: "Insulina",             categoria: "Avaliação Metabólica",    refTexto: "5–25 mcUI/mL",     ideal: { M: [null, 6], F: [null, 6] , sugestoes: { baixo: null, alto: ["Cromo quelato", "Magnésio quelato", "Ácido alfa-lipóico (ALA)", "Berberina (consultar médico)"] } }, unidade: "mcUI/mL" },
  { nome: "HOMA-IR",             categoria: "Avaliação Metabólica",    refTexto: "< 4",               ideal: { M: [null, 1.3], F: [null, 1.3] , sugestoes: { baixo: null, alto: ["Cromo quelato (200–400 mcg/dia)", "Magnésio quelato", "Ácido alfa-lipóico (ALA 300–600 mg/dia)", "Berberina 500 mg (consultar médico)"] } },
  ...
  { nome: "Hemoglobina Glicada",  categoria: "Avaliação Metabólica",    refTexto: "4,7–8,5%",         ideal: { M: [null, 5], F: [null, 5] , sugestoes: { baixo: null, alto: ["Cromo quelato", "Magnésio quelato", "Vitamina B1 (tiamina)", "Ácido alfa-lipóico (ALA)"] } }, unidade: "%",
  ...
  { nome: "Vitamina C",           categoria: "Avaliação Nutricional",   refTexto: "0,4–1,5 mg/L",    ideal: { M: [1.4, 1.9], F: [1.4, 1.9] , sugestoes: { baixo: ["Vitamina C (ácido ascórbico 500–2.000 mg/dia)", "Bioflavonoides"], alto: null } }, unidade: "mg/L" },
  { nome: "Vitamina D (25OHD3)",  categoria: "Avaliação Nutricional",   refTexto: "20–60 ng/mL",     ideal: { M: [50, 150], F: [50, 150] , sugestoes: { baixo: ["Vitamina D3 (2.000–10.000 UI/dia conforme nível)", "Vitamina K2 (MK7 100–200 mcg/dia)", "Magnésio quelato (cofator conversão D3)"], alto: null } }, unidade: "ng/mL",
    interpretacao: { baixo: "Pode causar deficiência óssea ou imunológica; aumentar exposição solar, considerar suplementação." } },
  { nome: "Magnésio",             categoria: "Avaliação Nutricional",   refTexto: "1,5–2,3 mg/dL",   ideal: { M: [2, 2.2], F: [2, 2.2] , sugestoes: { baixo: ["Magnésio quelato (300–500 mg/dia)", "Magnésio glicato ou malato (melhor absorção)"], alto: null } }, unidade: "mg/dL" },
  { nome: "Zinco sérico",         categoria: "Avaliação Nutricional",   refTexto: "66–110 mcg/dL",   ideal: { M: [96, 115], F: [96, 115] , sugestoes: { baixo: ["Zinco quelato ou bisglicinato (15–30 mg/dia)", "Vitamina B6 (cofator de zinco)"], alto: ["Avaliar excesso – pode inibir cobre; considerar Cobre quelato"] } }, unidade: "mcg/dL" },
  { nome: "Selênio",              categoria: "Avaliação Nutricional",   refTexto: "20–190 µg/L",      ideal: { M: [120, 180], F: [120, 180] , sugestoes: { baixo: ["Selenometionina (100–200 mcg/dia)", "Vitamina E (sinergismo antioxidante)"], alto: null } }, unidade: "µg/L" },
  { nome: "Cálcio Sérico",        categoria: "Avaliação Nutricional",   refTexto: "9–10,5 mg/dL",    ideal: { M: [9.3, 10.2], F: [9.3, 10.2] , sugestoes: { baixo: ["Cálcio citrato ou malato (500 mg/dia)", "Vitamina D3", "Vitamina K2 (MK7)"], alto: null } }, unidade: "mg/dL",
