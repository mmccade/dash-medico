...
export const PACIENTES_DEMO = [
  { id: 1, nome: "Mariana Alves Costa", idade: 42, sexo: "Feminino", altura: 1.64, objetivo: "Emagrecimento e controle de resistência insulínica", comorbidades: "Pré-diabetes, esteatose hepática grau I", inicio: "2025-12-08", ativo: true, ciclos: [
    { mes: "Dez/25", peso: 94.2, gordura: 41.0, massaMagra: 55.6, visceral: 13, unidade: "MG", doses: [2.5, 2.5, 2.5, 2.5], local: "Casa", suplementacao: "Vit. D 7.000 UI/sem · B12 · Ômega-3", colaterais: "Náusea leve nos primeiros dias", obs: "Início de protocolo. Orientada quanto à hidratação." },
    { mes: "Jan/26", peso: 90.8, gordura: 39.4, massaMagra: 55.0, visceral: 12, unidade: "MG", doses: [2.5, 2.5, 5, 5], local: "Casa", suplementacao: "Vit. D · B12 · Ômega-3 · Magnésio", colaterais: "Constipação ocasional", obs: "Titulação para 5mg na 3ª semana. Boa adesão." },
    { mes: "Fev/26", peso: 87.1, gordura: 37.8, massaMagra: 54.2, visceral: 11, unidade: "MG", doses: [5, 5, 5, 5], local: "Casa", suplementacao: "Vit. D · B12 · Ômega-3 · Magnésio", colaterais: "Sem queixas relevantes", obs: "Manutenção em 5mg. Mais disposição." },
    { mes: "Mar/26", peso: 84.0, gordura: 36.1, massaMagra: 53.7, visceral: 10, unidade: "MG", doses: [5, 5, 7.5, 7.5], local: "Casa", suplementacao: "Vit. D · B12 · Ômega-3 · Magnésio · Creatina", colaterais: "Náusea leve ao subir dose", obs: "Titulação para 7.5mg. Iniciada creatina." },
    { mes: "Abr/26", peso: 81.3, gordura: 34.7, massaMagra: 53.1, visceral: 9, unidade: "MG", doses: [7.5, 7.5, 7.5, 7.5], local: "Casa", suplementacao: "Vit. D · B12 · Ômega-3 · Magnésio · Creatina", colaterais: "Boa tolerância", obs: "Evolução consistente. Reavaliação laboratorial agendada." },
  ] },
